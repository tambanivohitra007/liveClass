...
export default function Footer() {
  return (
    <footer className="bg-linear-to-r from-[#0F1D3B] via-[#151F42] to-[#1E1840] text-white/50 py-8 border-t border-white/5">
      <div className="relative overflow-visible max-w-7xl mx-auto px-6 md:pr-36">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hidden md:block absolute right-6 bottom-0 rounded-3xl transition-all"
          aria-label="Developer profile"
        >
          <img src={boy4} alt="Developer avatar" className="w-28 h-28 rounded-3xl object-cover" />
        </a>
        ...
        <div className="mt-5 flex justify-end md:hidden">
          <a
            ...
            aria-label="Developer profile"
          >
            <img src={boy4} alt="Developer avatar" className="w-24 h-auto rounded-3xl" />
          </a>
        </div>
