...
const lightDefs: GradientDef[] = [
  // 1 — subtle purple sweep
  { c1: '#2D1B69', o1: 0.30, c2: '#1A0E3E', o2: 0.15, x1: '0', y1: '0', x2: '1', y2: '1' },
  // 2 — counter purple arc
  { c1: '#1A0E3E', o1: 0.25, c2: '#2D1B69', o2: 0.30, x1: '1', y1: '0', x2: '0', y2: '1' },
  // 3 — thin accent ribbon
  { c1: '#2D1B69', o1: 0.20, c2: '#1A0E3E', o2: 0.12, x1: '0', y1: '1', x2: '1', y2: '0' },
  // 4 — subtle top fill
  { c1: '#1A0E3E', o1: 0.15, c2: '#0F0825', o2: 0.08, x1: '0', y1: '1', x2: '1', y2: '0' },
];

const darkDefs: GradientDef[] = [
  { c1: '#1A0E3E', o1: 0.50, c2: '#2D1B69', o2: 0.30, x1: '0', y1: '0', x2: '1', y2: '1' },
  { c1: '#2D1B69', o1: 0.40, c2: '#1A0E3E', o2: 0.45, x1: '1', y1: '0', x2: '0', y2: '1' },
  { c1: '#1A0E3E', o1: 0.35, c2: '#2D1B69', o2: 0.25, x1: '0', y1: '1', x2: '1', y2: '0' },
  { c1: '#2D1B69', o1: 0.25, c2: '#1A0E3E', o2: 0.15, x1: '0', y1: '1', x2: '1', y2: '0' },
];
