...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white border-b border-brand/15 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 no-underline group">
          ...
          <span className="font-bold text-xl text-gray-900">Live<span className="text-brand">Class</span></span>
        </Link>
            ...
            <>
              ...
              <div ref={profileRef} className="relative ml-2">
                <button
                  ...
                  className="flex items-center gap-2 pl-2 pr-1 py-1 rounded-xl hover:bg-brand/5 transition-colors"
                >
                ...
                {profileOpen && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden animate-slide-down">
                    <div className="px-4 py-3 bg-gradient-to-r from-brand/5 to-accent/5 border-b border-gray-100">
                    ...
                    <div className="p-1.5">
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-brand/5 transition-colors text-left"
                      >
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg hover:bg-brand/5 transition-colors"
        >
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="md:hidden border-t border-brand/10 bg-white animate-slide-down">
          <div className="px-4 py-3 space-y-1">
            {firebaseUser ? (
              <>
                <div className="flex items-center gap-3 px-3 py-3 mb-2 bg-gradient-to-r from-brand/5 to-accent/5 rounded-xl">
                ...
                {(user?.role === 'student' || isApprovedTeacher) && (
                  <Link to={dashboardPath} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                    <LayoutDashboard className="w-4 h-4 text-gray-400" />
                    Dashboard
                  </Link>
                )}
                {isApprovedTeacher && (
                  <Link to="/classes" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                    <Users className="w-4 h-4 text-gray-400" />
                    Classes
                  </Link>
                )}
                {isApprovedTeacher && (
                  <Link to="/history" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                    <History className="w-4 h-4 text-gray-400" />
                    Session History
                  </Link>
                )}
                {isAdmin && (
                  <Link to="/admin" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                    <Shield className="w-4 h-4 text-gray-400" />
                    Admin
                  </Link>
                )}
                <Link to="/discover" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                  <Compass className="w-4 h-4 text-gray-400" />
                  Discover
                </Link>
                <Link to="/join" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                  <Gamepad2 className="w-4 h-4 text-gray-400" />
                  Join Game
                </Link>
                {user?.role === 'student' && (
                  <Link to="/join-class" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                    <UserPlus className="w-4 h-4 text-gray-400" />
                    Join Class
                  </Link>
                )}
                <Link to="/profile" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-brand/5 no-underline">
                  <Settings className="w-4 h-4 text-gray-400" />
                  Profile Settings
                </Link>
