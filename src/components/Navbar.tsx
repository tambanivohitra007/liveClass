          ...
          {firebaseUser ? (
            <>
              ...
              <div ref={profileRef} className="relative ml-2">
                ...
                {profileOpen && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-[4px_4px_0px_0px_#D4566B] border-2 border-gray-800 overflow-hidden animate-slide-down">
            ...
            <>
              ...
              <Link
                to="/login"
                className="ml-1 px-4 py-2 rounded-lg bg-brand text-white text-sm font-medium border-2 border-gray-800 shadow-[3px_3px_0px_0px_#D4566B] hover:shadow-[5px_5px_0px_0px_#D4566B] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all duration-300 no-underline"
              >
                Sign In
              </Link>
            </>
          ...
          <div className="px-4 py-3 space-y-1">
            {firebaseUser ? (
              ...
              <>
                ...
                <Link to="/signup" className="block mt-1 px-3 py-2.5 rounded-lg text-sm font-medium text-center bg-brand text-white border-2 border-gray-800 shadow-[3px_3px_0px_0px_#D4566B] no-underline">
                  Get Started Free
                </Link>
              </>
            )}
