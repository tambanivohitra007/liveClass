...
export default function TermsAndConditions() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-2">Terms and Conditions</h1>
      ...
      <div className="prose max-w-none space-y-8 text-gray-600 leading-relaxed text-[15px]">
        {/* 1 */}
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">1. Welcome to LiveClass</h2>
          <p>
        ...
        {/* 2 */}
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">2. Responsible Use and Conduct</h2>

          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">2.1 General Principles</h3>
          ...
          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">2.2 Educational Context</h3>
          <p>
          ...
          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">2.3 Fair Play</h3>
          <p>
        ...
        {/* 4 */}
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">4. Service Plans</h2>
          <p>
        ...
        <section>
          ...
          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">5.1 Your Content</h3>
          <p>
          ...
          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">5.2 Content Responsibility</h3>
          <p>
          ...
          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">5.3 Content Moderation</h3>
          <p>
          ...
          <h3 className="text-base font-semibold text-gray-800 mt-4 mb-2">5.4 Public Content</h3>
          <p>
        ...
        {/* 8 */}
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">8. Account Security</h2>
          <p>
        ...
        {/* 9 */}
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-3">9. Data Protection</h2>
          <p>
