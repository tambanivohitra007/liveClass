    ...
    <div className="relative min-h-screen bg-linear-to-b from-[#E8EAF0] to-surface dark:from-surface-dark dark:to-surface-dark overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-white dark:bg-white/10 text-brand rounded-full text-sm font-bold border-2 border-gray-800 dark:border-white/20 shadow-[3px_3px_0px_0px_#D4566B] mb-5">
        ...
        <div className="relative mb-10 max-w-lg mx-auto group">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3.5 rounded-2xl border-2 border-gray-800 dark:border-white/20 focus:border-brand focus:ring-4 focus:ring-brand/20 outline-none transition-all text-gray-800 dark:text-white bg-white dark:bg-white/5 font-medium shadow-[3px_3px_0px_0px_rgba(107,114,128,0.2)] focus:shadow-[3px_3px_0px_0px_#D4566B]"
          />
        </div>
        ...
        {error ? (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="px-6 py-2.5 text-sm font-bold text-brand border-2 border-gray-800 dark:border-white/20 rounded-xl shadow-[2px_2px_0px_0px_#D4566B] hover:shadow-[4px_4px_0px_0px_#D4566B] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all duration-300 bg-white dark:bg-white/10"
            >
              Try again
            </button>
          </div>
          ...
          <div className="text-center py-16">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-gray-800 dark:border-white/20 bg-gray-50 dark:bg-white/10 shadow-[3px_3px_0px_0px_rgba(107,114,128,0.2)] mb-5">
