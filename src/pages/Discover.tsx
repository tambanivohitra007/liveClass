    ...
    <div className="relative min-h-screen bg-gradient-to-b from-[#E8EAF0] to-surface overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-white text-brand rounded-full text-sm font-bold border-2 border-gray-800 shadow-[3px_3px_0px_0px_#D4566B] mb-5">
            <Globe className="w-4 h-4" />
            Public Library
          </div>
          <h1 className="text-4xl font-black text-gray-900">Discover Quizzes</h1>
          <p className="text-gray-500 mt-2 font-medium">Browse and clone public quizzes created by the community</p>
        </div>
        ...
        <div className="relative mb-10 max-w-lg mx-auto group">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3.5 rounded-2xl border-2 border-gray-800 focus:border-brand focus:ring-4 focus:ring-brand/20 outline-none transition-all text-gray-800 bg-white font-medium shadow-[3px_3px_0px_0px_rgba(107,114,128,0.2)] focus:shadow-[3px_3px_0px_0px_#D4566B]"
          />
        </div>
        ...
        {error ? (
          <div className="text-center py-16">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-gray-800 bg-danger/10 shadow-[3px_3px_0px_0px_#EF4444] mb-5">
              <Globe className="w-7 h-7 text-danger" />
            </div>
            <p className="text-gray-500 mb-4 font-medium">Something went wrong loading quizzes.</p>
            <button
              onClick={() => window.location.reload()}
              className="px-6 py-2.5 text-sm font-bold text-brand border-2 border-gray-800 rounded-xl shadow-[2px_2px_0px_0px_#D4566B] hover:shadow-[4px_4px_0px_0px_#D4566B] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-300 bg-white"
            >
              Try again
            </button>
          </div>
          ...
          <div className="text-center py-16">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-gray-800 bg-gray-50 shadow-[3px_3px_0px_0px_rgba(107,114,128,0.2)] mb-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 stagger-children">
            {filtered.map((quiz) => (
              <div
                key={quiz.id}
                className="group bg-white rounded-2xl border-2 border-gray-800 shadow-[4px_4px_0px_0px_#D4566B] hover:shadow-[6px_6px_0px_0px_#D4566B] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-300 animate-fade-in overflow-hidden flex flex-col"
              >
                {/* Color accent bar */}
                ...
                <div className="p-6 flex-1">
                  <h3 className="font-bold text-gray-900 line-clamp-1 mb-1.5">{quiz.title}</h3>
                  <p className="text-sm text-gray-500 line-clamp-2 mb-4">{quiz.description || 'No description'}</p>
                ...
                <div className="px-6 py-4 border-t-2 border-gray-100">
                  <button
                    ...
                    className="w-full py-2.5 text-sm font-bold text-brand bg-brand/5 hover:bg-brand hover:text-white rounded-xl border-2 border-gray-800 shadow-[2px_2px_0px_0px_#D4566B] hover:shadow-[3px_3px_0px_0px_#D4566B] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
                  >
