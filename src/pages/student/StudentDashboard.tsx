    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-brand text-white font-semibold rounded-xl border-2 border-gray-800 dark:border-gray-300 shadow-[4px_4px_0px_0px_#D4566B] hover:shadow-[6px_6px_0px_0px_#D4566B] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-300 flex items-center gap-2"
        >
        ...
        <section className="mb-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {activeAssignments.map((a) => (
              <div key={a.id} className="bg-white rounded-2xl border-2 border-gray-800 dark:border-gray-300 shadow-[3px_3px_0px_0px_#22C55E] hover:shadow-[6px_6px_0px_0px_#22C55E] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all duration-300 group">
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-3">
                ...
                <div className="px-6 py-3 border-t border-gray-50">
                  <button
                    ...
                    className="w-full py-2 text-sm font-medium text-white bg-success rounded-lg border-2 border-gray-800 dark:border-gray-300 shadow-[3px_3px_0px_0px_#22C55E] hover:shadow-[5px_5px_0px_0px_#22C55E] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all duration-300 flex items-center justify-center gap-1"
                  >
