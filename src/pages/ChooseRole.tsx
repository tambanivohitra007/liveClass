    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 bg-linear-to-b from-[#E8EAF0] to-surface dark:from-surface-dark dark:to-surface-dark relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          <img src={logo} alt="LiveClass" className="w-16 h-16 rounded-2xl mx-auto mb-4 border-2 border-gray-200 dark:border-white/20 shadow-sm" />
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-white dark:bg-white/5 rounded-3xl border-2 border-gray-200 dark:border-white/20 shadow-sm transition-shadow duration-300 group-hover:shadow-md" />

          <div className="relative p-8">
            {error && (
              <div className="mb-5 p-3 bg-white dark:bg-white/5 rounded-xl border-2 border-gray-200 dark:border-white/20 shadow-sm text-danger text-sm font-bold text-center animate-fade-in">
                {error}
              </div>
            )}
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-4 rounded-2xl border-2 font-bold transition-all duration-300 text-left ${
                      active
                        ? 'border-gray-200 dark:border-white/20 bg-brand/10 text-gray-900 dark:text-white shadow-sm'
                        : 'border-gray-300 dark:border-white/20 text-gray-400 dark:text-white/50 hover:border-gray-200 dark:hover:border-white/30 hover:text-gray-600 dark:hover:text-white/70 shadow-[2px_2px_0px_0px_rgba(107,114,128,0.2)]'
                    }`}
                  >
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center border-2 ${
                      active ? 'border-gray-200 dark:border-white/20 bg-brand/20 text-brand' : 'border-gray-300 dark:border-white/20 bg-gray-100 dark:bg-white/10 text-gray-400 dark:text-white/40'
                    }`}>
